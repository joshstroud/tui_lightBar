  ...
  if ( !beatTriggered )
  {
    for (Map.Entry row : drumRow.entrySet ())
    {
      if (((boolean[])row.getValue())[beat]) {
        boolean fire = false; 
        if (row.getKey().equals("kck") && trigger[0] ) { 
          fire = true; 
          ledColor = 30;
        }
        if (row.getKey().equals("hat") && trigger[1]) {
          fire = true;
          ledColor = 60;
        }
        if (row.getKey().equals("pr1") && trigger[2]) {
          fire = true;
          ledColor = 120;
        }
        ...
        if (row.getKey().equals("tm1") && trigger[5]) {
          fire = true; 
          ledColor = 240;
        }
        if (row.getKey().equals("tm2") && trigger[6]) {
          fire = true;
          ledColor = 270;
        }
        if (row.getKey().equals("snr") && trigger[7]) {
          fire = true; 
          ledColor = 300;
        }
        if (fire)
